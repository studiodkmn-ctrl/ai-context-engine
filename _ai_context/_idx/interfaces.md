...
> Auto-generiert: 2026-08-08 22:11 | Neu generieren: `bash _ai_context/scripts/ai-interface-snapshot.sh`
...
ManifestEntry                   mcp/src/lib/locate.ts:253            path, type
SymbolHit                       mcp/src/lib/locate.ts:358            name, file, line, args, score, name, file, line
InterfaceHit                    mcp/src/lib/locate.ts:394            name, file, line, fields, score, id, level, rule
Invariant                       mcp/src/lib/locate.ts:424            id, level, rule, scope
LocateResult                    mcp/src/lib/locate.ts:484            markdown, hitCount, filesToRead
