...
> Noch nicht gescannt. Einmal ausführen:
> `bash _ai_context/scripts/ai-context-map.sh`

| Element | Component:Zeile | Handler | State/Store | Endpoint |
|---|---|---|---|---|
| _(leer bis zum ersten Scan)_ | | | | |
