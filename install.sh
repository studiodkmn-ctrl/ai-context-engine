#!/usr/bin/env bash
# =============================================================================
# install.sh — Globale Installation der AI Context Engine (Version: siehe VERSION)
#
# Modi:
...
if $REFRESH; then
  ...
  echo -e "${BOLD}🧠 AI Context v${ENGINE_VERSION} — Pro Installation${NC}"
  echo -e "   Basis + Ollama + RAG-Cache + Embeddings"
else
  echo -e "${BOLD}🧠 AI Context v${ENGINE_VERSION} — Simple Installation${NC}"
...
# AI Context — Ollama-Konfiguration
...
# =============================================================================
echo ""
echo -e "${GREEN}✅ AI Context v${ENGINE_VERSION} installiert${NC}"
echo ""
